...

{
        ...
        document.getElementById("canvas6Grep").style.visibility="visible";
...

{
        ...
        document.getElementById("canvas6_re(2)").style.visibility="hidden";

        document.getElementById("canvas6Grep2").style.visibility="visible";
        
}

function navNextGrep3()

{

        document.getElementById("canvas6Grep").style.visibility="hidden";


        document.getElementById("canvas6Grep2").style.visibility="visible";

        // document.getElementById("canvasrec6").style.visibility="visible";

        // document.getElementById("okrecube_tb").style.visibility="visible";
        // document.getElementById("arrowrec").style.visibility="visible";
        
}

function navNextGrep4()

{

        document.getElementById("canvas6_re(1)").style.visibility="hidden";

        document.getElementById("canvasre2c6").style.visibility="visible";
...
function recentre()
{
    document.getElementById("arrowrec").style.visibility="hidden";
    document.getElementById("okrecube_tb").style.visibility="hidden";
    document.getElementById("okrecube").style.animation="recube 3s 2";
        setTimeout(function()
        {
            document.getElementById("startstep_re").style.visibility="visible";
            document.getElementById("bigclk_tb").style.visibility="visible";
            document.getElementById("arrow6re").style.visibility="visible";
        },6000);
...

{
        ...
        document.getElementById("canvas6Grep2").style.visibility="hidden";
        
        document.getElementById("canvas6Grep3").style.visibility="visible";
        

        // document.getElementById("canvas_un2c6").style.visibility="visible";
        // setTimeout(function()
        // {
        //     stopmoveclk1_un()
        // },2000);
...
function navNext_unG4()

{

        document.getElementById("canvas_un2c6").style.visibility="hidden";
...

{
        ...
        document.getElementById("canvas6Grep3").style.visibility="hidden";

        document.getElementById("canvas6Grep4").style.visibility="visible";
...

{
        ...
        document.getElementById("canvas6Grep4").style.visibility="hidden";

        document.getElementById("canvas6Grep5").style.visibility="visible";
...

{
        ...
        document.getElementById("canvas6Grep5").style.visibility="hidden";

        document.getElementById("canvas6Grep6").style.visibility="visible";
...

{
        ...
        document.getElementById("canvas6Grep6").style.visibility="hidden";

        document.getElementById("canvas6Grep7").style.visibility="visible";
...

{
        ...
        document.getElementById("canvas6Grep7").style.visibility="hidden";

        document.getElementById("canvas6Grep8").style.visibility="visible";
...

{
        ...
        document.getElementById("canvas6Grep8").style.visibility="hidden";

        document.getElementById("canvas6Grep9").style.visibility="visible";
        
        /*document.getElementById("canvas_br2c6").style.visibility="visible";
        showmoveclk_br()
         document.getElementById("canvas6Grep9").style.visibility="visible";
        */
}
...

{
        ...
        document.getElementById("canvas_br2c6").style.visibility="hidden";
...

{
    ...
    document.getElementById("canvas6Grep9").style.visibility="hidden";

    document.getElementById("can6Graph1").style.visibility="visible";
...

{
        ...
        document.getElementById("can6Graph1").style.visibility="hidden";
         
        document.getElementById("can6Graph2").style.visibility="visible";
...

{
        ...
        document.getElementById("can6Graph2").style.visibility="hidden";
         
        document.getElementById("can6Graph3").style.visibility="visible";
...

{
        ...
        document.getElementById("can6Graph3").style.visibility="hidden";
         
        document.getElementById("can6Graph4").style.visibility="visible";
...

{
  ...
  /*  else if (numbox == 5.25 && size == 15)
    ...
    {
        document.getElementById("numoutnext").innerHTML = "Incorrect<br>Enter Correct Value:<br><br> 14 N/(mm<sup>2</sup>/min).<br><br>";
...
function movecube1(){
    ...
    setTimeout(function()
        {
            document.getElementById("movegauge1").style.visibility="visible";
            document.getElementById("movegauge1").style.animation="movegauge11 2s forwards";
            setTimeout(function()
            {
        // document.getElementById("cubechangectm").style.visibility="visible";

            document.getElementById("toppad1").style.visibility="visible";
            document.getElementById("toppad2").style.visibility="visible";
            // document.getElementById("movegauge1").style.visibility="visible";
        document.getElementById("toppad1").style.animation="movetoppad11 2s forwards";

        document.getElementById("toppad2").style.animation="movetoppad21 2s forwards";
        setTimeout(function()
            {
        ...
        document.getElementById("cubedatehidden5").style.visibility="hidden";
                ...
                document.getElementById("movegauge1").style.visibility="hidden";
                document.getElementById("toppad1").style.visibility="hidden";
                document.getElementById("toppad2").style.visibility="hidden";
                document.getElementById("cubechangectmold").style.visibility="visible";
                document.getElementById("gaugelengthimg").style.visibility="visible";
                document.getElementById("gaugelengthtext").style.visibility="visible";
        ...
        document.getElementById("cubefro mctm").style.visibility="hidden";
        // document.getElementById("arrow2").style.visibility="visible";
...
setTimeout(function()
{
document.getElementById("wiregauge1").style.visibility="visible";
document.getElementById("fitcubenext4b").style.visibility="visible";
document.getElementById("nextButton4b").style.visibility="visible";
},3100);    
...
function showmoveclk()
{
    ...
    setTimeout(function()
    {
       if (sizel == 300)//numbox == 2.33 && size == 10)
        ...
        document.getElementById("pin1").style.animation="clockpin10 4.00s forwards";
        ...
        document.getElementById("pin1").style.animation="clockpin15 4.00s forwards";
...
/* recenter code start here */


function showbigclk_re()
{

    document.getElementById("arrow6re").style.visibility="hidden";
    document.getElementById("bigclk_tb").style.visibility="hidden";
    //document.getElementById("transnumbox1").style.animation="cubeFromCuringTank 2s forwards";

    document.getElementById("bigclock_re1").style.visibility="visible";
    document.getElementById("pin1_re1").style.visibility="visible";
    document.getElementById("pin2_re1").style.visibility="visible";
    document.getElementById("clkdot_re1").style.visibility="visible";

    document.getElementById("arrow7_re1").style.visibility="visible";
    document.getElementById("strtbtn_re1").style.visibility="visible";
    document.getElementById("startstep_re2").style.visibility="visible";
    document.getElementById("clktable_re1").style.visibility="visible";
}
    
function showmoveclk_re()
{
    document.getElementById("strtbtn_re1").style.visibility="hidden";
    document.getElementById("arrow7_re1").style.visibility="hidden";
    document.getElementById("stopstep_re1").style.visibility="visible";
    setTimeout(function()
    {
       if (sizel == 300)//numbox == 2.33 && size == 10)
        {
        
        document.getElementById("pin1_re1").style.animation="clockpin10 4.00s forwards";
        document.getElementById("pin2_re1").style.animation="clockpin210 4.00s forwards";
        ...
        animateValue("value_re1", 60, 0, 60000);
        /*Countdown Timer Animation Code End*/

        document.getElementById("press1_re1").style.visibility="visible";
        document.getElementById("press2_re1").style.visibility="visible";
        document.getElementById("secclock1_re1").style.visibility="visible";
            
            // document.getElementById("stopstep_re1").style.visibility="visible";
            
            setTimeout(function()
            {
                document.getElementById("canvasrec6").style.visibility="hidden";
                document.getElementById("canvas6_re(1)").style.visibility="visible";
...
/* recenter code end here */
    
function showmoveclk_up()
{
    // document.getElementById("strtbtn_re1").style.visibility="hidden";
    // document.getElementById("arrow7_re1").style.visibility="hidden";
    setTimeout(function()
    {
       if (sizel == 300)//numbox == 2.33 && size == 10)
        ...
        document.getElementById("pin1a_up1").style.animation="clockpin10a 4.00s forwards";
        document.getElementById("pin2a_up1").style.animation="clockpin210a 4.00s forwards";
        ...
        animateValue("value_up1", 60, 0, 60000);
        /*Countdown Timer Animation Code End*/

        // document.getElementById("press1_re1").style.visibility="visible";
        // document.getElementById("press2_re1").style.visibility="visible";
        document.getElementById("secclock2_up1").style.visibility="visible";
            
            // document.getElementById("startstepup1").style.visibility="visible";
            
            setTimeout(function()
            {
                document.getElementById("canvas_up2c6").style.visibility="hidden";
                document.getElementById("canvas6Grep4").style.visibility="visible";
...
function showmoveclk_br()
{
    ...
    setTimeout(function()
    {
       if (sizel == 300)//numbox == 2.33 && size == 10)
        ...
        document.getElementById("pin1a_br1").style.animation="clockpinbr1 4.00s forwards";
        document.getElementById("pin2a_br1").style.animation="clockpinbr1 4.00s forwards";

        setTimeout(function()
            {
                // document.getElementById("breaknext62").style.visibility="visible";
                // document.getElementById("nextButtonbr1").style.visibility="visible";
                document.getElementById("press1a_br").style.visibility="hidden";
                document.getElementById("press2a_br").style.visibility="hidden";
                document.getElementById("brcube").style.visibility="hidden";
                setTimeout(function()
                {
                    navNextG11()
                },2000);
...
function showmoveclk1()
{
    ...
    setTimeout(function()
    {
       if (sizel == 300)//numbox == 2.33 && size == 10)
        ...
        document.getElementById("pin1a").style.animation="clockpin10a 4.00s forwards";
...
function showmoveclk_re1()
{
    // document.getElementById("strtbtn1").style.visibility="hidden";
    // document.getElementById("arrow61").style.visibility="hidden";
    // document.getElementById("startstepre1").style.visibility="visible";
    ...
    setTimeout(function()
    {
       if (sizel == 300)//numbox == 2.33 && size == 10)
        ...
        document.getElementById("pin1a_re1").style.animation="clockpin10a 4.00s forwards";
        document.getElementById("pin2a_re1").style.animation="clockpin210a 4.00s forwards";
setTimeout(function()
            {
        /*Countdown Timer Animation Code Start*/  
        function animateValue(id, start, end, duration) {
        ...
        animateValue("value1_re1", 60, 0, 60000);
        /*Countdown Timer Animation Code End*/

        // document.getElementById("press1a").style.visibility="visible";
        // document.getElementById("press2a").style.visibility="visible";
        document.getElementById("secclock2_re1").style.visibility="visible";
            
            // document.getElementById("stopstep1_re1").style.visibility="visible";

            setTimeout(function()
            {
                document.getElementById("canvasre2c6").style.visibility="hidden";
                document.getElementById("canvas6_re(2)").style.visibility="visible";
...
function stopmoveclk1_un()
{
    // document.getElementById("arrow62_un").style.visibility="hidden";
    // document.getElementById("stopbtn1_un").style.visibility="hidden";
    document.getElementById("press1a_un").style.visibility="hidden";
    document.getElementById("press2a_un").style.visibility="hidden";

        document.getElementById("pin1a_un1").style.animation="clock_unload 4.00s forwards";
        document.getElementById("pin2a_un1").style.animation="clock_unload 4.00s forwards";
    setTimeout(function()
    {
        // document.getElementById("arrow63_un").style.visibility="visible";
        // document.getElementById("navNext_unG4").style.visibility="visible";
        navNext_unG4()
    },4000);
}
